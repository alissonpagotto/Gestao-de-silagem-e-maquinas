    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col flex-1 overflow-y-auto bg-blue-700 dark:bg-stone-900 scrollbar-none">
          ...
          {/* Atalhos Rápidos do Ecossistema: Landing Page & Admin Mestre */}
          <div className="mt-4 pt-3 border-t border-blue-800/40 dark:border-stone-800/80 space-y-1.5 px-1">
            <button
              type="button"
              onClick={() => {
                try {
                  ...
                  window.location.search = '?view=landing';
                }
              }}
              className="w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs font-bold text-blue-200 hover:text-white hover:bg-blue-600/30 dark:text-stone-300 dark:hover:bg-stone-800 transition cursor-pointer group"
            >
              <div className="flex items-center space-x-2.5 truncate">
                <Globe className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                <span className="truncate">Landing Page Pública</span>
              </div>
              <ChevronRight className="w-3 h-3 text-blue-300/60 dark:text-stone-500 group-hover:text-white shrink-0" />
            </button>
            ...
            <button
              ...
              onClick={() => {
                try {
                  ...
                  window.location.href = '/master-admin?key=agro123';
                }
              }}
              className="w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs font-bold text-amber-200/90 hover:text-amber-100 hover:bg-amber-500/20 dark:text-amber-300/80 dark:hover:bg-amber-950/40 transition cursor-pointer group border border-amber-500/30"
            >
              <div className="flex items-center space-x-2.5 truncate">
                <ShieldCheck className="w-3.5 h-3.5 text-amber-400 shrink-0" />
                <span className="truncate font-black">Admin Mestre</span>
              </div>
              <span className="text-[10px] bg-amber-400/20 text-amber-300 px-1.5 py-0.5 rounded-full font-black">
                agro123
              </span>
            </button>
          </div>
