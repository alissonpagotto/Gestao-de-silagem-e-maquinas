...
import { PlanDefinition, SubscriberStatus } from '../../types/masterAdmin';
...
export const AuthPage: React.FC<AuthPageProps> = ({
  ...
  // Atualiza parâmetros caso a URL mude
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-100 font-['Plus_Jakarta_Sans',sans-serif] selection:bg-emerald-500 selection:text-stone-950 flex flex-col justify-between py-6 px-4 sm:px-6">
      
      {/* BARRA SUPERIOR: VOLTAR E LOGO */}
      <div className="max-w-4xl w-full mx-auto flex items-center justify-between pb-6 border-b border-stone-800">
        <button
          type="button"
          onClick={onOpenLandingPage}
          className="inline-flex items-center gap-2 text-xs font-bold text-stone-400 hover:text-emerald-400 transition cursor-pointer"
        >
      ...
      <div className="max-w-4xl w-full mx-auto my-auto py-8">
        ...
        <div className="text-center space-y-2 mb-8">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-950/60 border border-emerald-800/60 text-emerald-400 text-xs font-black">
        ...
        {formError && (
          <div className="mb-6 p-4 rounded-xl bg-rose-950/60 border border-rose-800/80 text-rose-300 text-xs font-bold flex items-center gap-3">
        ...
        {successMessage && (
          <div className="mb-6 p-4 rounded-xl bg-emerald-950/70 border border-emerald-800 text-emerald-300 text-xs font-bold flex items-center gap-3">
        ...
        {mode === 'signup' ? (
          <form onSubmit={handleSignUpSubmit} className="space-y-6">
            ...
            <div className="bg-stone-900/60 border border-stone-800/90 rounded-2xl p-5 sm:p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2 space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 bg-stone-950 border border-stone-700 rounded-xl text-xs sm:text-sm text-white focus:ring-2 focus:ring-emerald-500 outline-none"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 bg-stone-950 border border-stone-700 rounded-xl text-xs sm:text-sm text-white focus:ring-2 focus:ring-emerald-500 outline-none pl-10"
                    />
                ...
                <div className="sm:col-span-2 space-y-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 bg-stone-950 border border-stone-700 rounded-xl text-xs sm:text-sm text-white focus:ring-2 focus:ring-emerald-500 outline-none pl-10 pr-10"
                    />
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-4 px-6 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-stone-950 font-black text-sm uppercase tracking-wider rounded-xl transition shadow-xl shadow-emerald-950/60 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
                {isLoading ? (
                  <>
              ...
              <div className="pt-4 flex items-center justify-center gap-4 text-[11px] text-stone-400">
          ...
          /* MODO LOGIN: ENTRAR */
          <form onSubmit={handleLoginSubmit} className="max-w-md mx-auto space-y-4 bg-stone-900/80 border border-stone-800 p-6 sm:p-8 rounded-3xl">
            <div className="space-y-1">
              <label className="block text-xs font-bold text-stone-300">
                E-mail de Acesso
              </label>
            ...
            <div className="pt-3 text-center">
              <button
                type="button"
                onClick={() => { setMode('signup'); setFormError(null); }}
                className="text-xs text-stone-400 hover:text-emerald-400 transition cursor-pointer"
              >
      ...
      {/* RODAPÉ SIMPLES */}
      <div className="max-w-4xl w-full mx-auto text-center pt-6 border-t border-stone-900 text-xs text-stone-500">
